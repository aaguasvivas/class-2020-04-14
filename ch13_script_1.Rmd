...
```
Estimates: being male correlates to a 0.04 decrease in preference for democrats for every singe unit increase income, there is an associate decrease of 0.07 decrease in preference for democrats

Income (Bayes and Frequentist): Bayesian would be that there is 95% certainty that the true value of the treatment effect (b1) and Frequentist would be that in the long run (infinite samples), 95% of the time the true value of the treatment effect will be contained within those intervals

The more money you have, the less likely you are to vote for Democrats
...
nes %>%
  ...
  summarise(perc_dvote = mean(dvote),
